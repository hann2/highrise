 ...
 *
 * It extends {@link PlanarEquation2D} so the solver uses the
 * shape-specialized iteration path rather than the general 6-component loop. The contact-specific state
