 ...
 *
 * Pure angular with asymmetric Jacobian (body A contributes `ratio`,
 * body B contributes `−1`), which is why {@link AngularEquation2D} stores
 * the two angular terms independently.
 */
