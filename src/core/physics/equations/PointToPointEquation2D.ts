/**
 * Shape-specialized 2-body equation for **particle ↔ particle**
 * constraints. Both bodies contribute only linear terms — no angular. The
 ...
 * ## Storage
 *
 * Two floats instead of a 6-element `G`:
 *   - `nx, ny` — the unit direction (body A side gets the negation)
 *
 * ## When to use
 *
 * Distance-like constraints where both bodies are particle-like
 * (`pm2d × pm2d`), e.g. links between adjacent particles of a chain.
 */
