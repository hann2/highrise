...
export class RevoluteConstraint extends Constraint {
  ...
  update(): this {
    ...
    // Lever arms: local pivots rotated into world frame by each body's angle.
    ...
    // X-position equation: torque from rA × x̂ is +rAy, from rB × x̂ is -rBy.
    x.G[0] = -1;
    x.G[1] = 0;
    x.G[2] = rAy;
    x.G[3] = 1;
    ...
    // Y-position equation: torque from rA × ŷ is -rAx, from rB × ŷ is +rBx.
    y.G[0] = 0;
    y.G[1] = -1;
    y.G[2] = -rAx;
    y.G[3] = 0;
