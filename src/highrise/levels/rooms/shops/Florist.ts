...
export default class Florist implements RoomTemplate {
  ...
  generateEntities(
    ...
    entities.push(
      new Decoration(roomToWorldPosition(V(0.28, 0.28)), vaseEmpty)
    );
    entities.push(new Decoration(roomToWorldPosition(V(1.4, -0.15)), vaseRose));
    entities.push(
      new Decoration(roomToWorldPosition(V(2.1, -0.15)), vaseRoses)
    );
    entities.push(
      new Decoration(roomToWorldPosition(V(2.1, -0.15)), vaseTulips)
    );
    entities.push(
      new Decoration(roomToWorldPosition(V(2.1, -0.15)), housePlantShort1)
    );
    entities.push(
      new Decoration(roomToWorldPosition(V(2.1, -0.15)), housePlantShort2)
    );
    entities.push(
      new Decoration(roomToWorldPosition(V(2.1, -0.15)), housePlantTall1)
    );
    entities.push(
      new Decoration(roomToWorldPosition(V(2.1, -0.15)), housePlantTall2)
    );
    entities.push(
      new Decoration(roomToWorldPosition(V(2.1, -0.15)), housePlantTall3)
    );
    entities.push(
      new PointLight({
        radius: 6,
