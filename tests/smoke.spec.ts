...
const LEVEL_2_FINGERPRINT = "334:-298868236";
...
test("game boots, plays, and changes levels without errors", async ({
  ...
  await page.keyboard.press("KeyU"); // dev cheat: fill the reserves
  await page.keyboard.press("KeyR");
  ...
  await page.keyboard.press("KeyU"); // dev cheat: fill the reserves again
  expectNoIssues(issues);
