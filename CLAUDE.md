...
- Stats-as-data: guns, melee weapons, characters, decorations, zombie variants, and upgrades are plain objects in their own files, collected in an index (`gunStats.ts`, `weapons.ts`, `decorations.ts`, `Character.ts`, `upgrades.ts`).
